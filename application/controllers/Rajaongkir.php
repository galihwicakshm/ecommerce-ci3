...
class Rajaongkir extends CI_Controller
 {
    private $api_key = '60903997ed12260e275e96249d2af8f8';
    ...
    //echo $response;
       ...
       // print_r($array_response['rajaongkir']['results']);
        ...
        foreach ($data_provinsi as $key => $value) {
            echo "<option value='" . $value['province']."' id_provinsi='".$value['province_id']."'>" .$value['province']."</
            option>";
            }
        }
    ...
    {
        $curl = curl_init();
        $id_provinsi_pilih = $this->input->post('id_provinsi');
