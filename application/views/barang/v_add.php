        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Stok</label>
                        <input type="number" min="0" name="stock" class="form-control" placeholder="Stok Barang" value="<?= set_value('stock') ?>">
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="form-group">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="number" min="0" name="berat" class="form-control" placeholder="Berat Barang dalam Gram" value="<?= set_value('berat') ?>">
                    </div>
                </div>
            </div>
