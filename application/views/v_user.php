            ...
            <div class="modal-body">
                ...
                ?>
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" name="nama_admin" class="form-control" placeholder="Nama User" required>
                  </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ?>
                 ...
                 <div class="form-group">
                    <label>Nama User</label>
                    <input type="text" name="nama_admin" value="<?=$value->nama_admin?>" class="form-control" placeholder="Nama User" required>
                  </div>
...
<?php foreach ($user as $key => $value){ ?>
    <div class="modal fade" id="edit<?=$value->id_admin?>" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1"><?=$value->nama_admin?></h5>
                                <button
                                  type="button"
                                  class="btn-close"
                                  data-dismiss="modal"
...
<?php foreach ($user as $key => $value){ ?>
 ...
 <div class="modal fade" id="delete<?=$value->id_admin?>" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel1"><?= $value-> nama_admin?></h5>
